...
description: "Every entity in Manizales de Pie follows a four-file pattern — DTO, policy, DAL, actions. Learn the contract each file holds and the mutation order that is never broken."
---
