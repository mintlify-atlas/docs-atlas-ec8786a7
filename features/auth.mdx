---
title: "Authentication: Google OAuth Sign-In via Supabase Auth"
sidebarTitle: "Authentication"
description: "Manizales de Pie uses Google OAuth via Supabase Auth. An account is only required for volunteer calls — the map and all reports are always anonymous."
---
