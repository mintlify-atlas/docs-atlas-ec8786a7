...
description: "Manizales de Pie's core map uses MapLibre GL with custom HTML markers, pin clustering, fan layout for co-located points, and a unified panel with category chips."
---
