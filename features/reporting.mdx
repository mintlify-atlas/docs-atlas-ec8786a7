...
description: "Anyone can report an aid site, community need, lost animal, or resource offer — no account required. Reports are published immediately and labeled as unconfirmed."
---
...
Reporting never requires a Google account. The only action that requires sign-in is **creating a volunteer call (jornada)**, because it commits other people to a time and a place — from the moment the row exists, other people move their Saturday and hand their phone number to whoever organized it. The account wall appears at the end of the form (`PublishGate`), after the draft is complete, and the draft including the pin survives the trip through Google sign-in.
