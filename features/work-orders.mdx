...
description: "Work orders are specific community needs — debris removal, structural risk, supplies — tracked through an anonymous activity thread that derives status from behavior, not declarations."
---
