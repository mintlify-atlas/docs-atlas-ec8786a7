---
title: "Deploying Manizales de Pie to Vercel"
...
- **Google OAuth** — `https://accounts.google.com` is covered via the `frame-src` and `script-src` directives to support the Google sign-in flow.
